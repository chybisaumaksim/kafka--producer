...
public class ProducerController {
    ...
    public ProducerResponse createClient(@RequestBody Client client) {
        ...
        return new ProducerResponse("Client created successfully");
    }

    @SneakyThrows
    @PostMapping(path = "/transaction", produces = APPLICATION_JSON_VALUE)
    public ProducerResponse createTransaction(@RequestBody Transaction transaction) {
        ...
        return new ProducerResponse("Transaction created successfully");
    }
}